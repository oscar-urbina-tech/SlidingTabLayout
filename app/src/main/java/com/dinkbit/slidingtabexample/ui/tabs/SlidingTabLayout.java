package com.dinkbit.slidingtabexample.ui.tabs;

/**
 * Created by oscar.urbina on 3/4/15.
 */
/*
...
import com.dinkbit.slidingtabexample.MainActivity;
...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    /**
     * Log tag for current class.
     */
    private static final String LOG_TAG = SlidingTabLayout.class.getSimpleName();
     ...
     */
    public void setCustomTabView(final int layoutResId,final int textViewId,final int imageViewId) {
    ...
    private void populateTabStrip() {
        ...
        final MainActivity.SectionsPagerAdapter adapter = (MainActivity.SectionsPagerAdapter)mViewPager.getAdapter();
